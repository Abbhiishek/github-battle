...
export default function Home() {
  ...
  const prevUsername1 = useRef<string | null>(null);
  const prevUsername2 = useRef<string | null>(null);
  ...
  // Trigger comparison when usernames change
  useEffect(() => {
    if (
      username1 &&
      username2 &&
      (username1 !== prevUsername1.current || username2 !== prevUsername2.current)
    ) {
      handleCompare();
